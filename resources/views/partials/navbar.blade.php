<nav class="fixed w-full top-0 z-50 bg-white shadow-sm" x-data="{ mobileMenu: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="#about" class="text-gray-600 hover:text-orange-500 text-sm font-medium transition-colors">About Us</a>
                <a href="#contact" class="text-gray-600 hover:text-orange-500 text-sm font-medium transition-colors">Contact Us</a>
                <a href="{{ route('login') }}" class="bg-orange-500 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-orange-600 transition-colors">Login</a>
            </div>
            @else
            <div class="hidden md:flex items-center space-x-8">
                <a href="{{ route('landing') }}" class="text-gray-{{ request()->routeIs('landing') ? '900' : '600' }} hover:text-orange-500 text-sm font-medium transition-colors">Home</a>
                ...
                <a href="{{ route('register') }}" class="bg-orange-500 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-orange-600 transition-colors">Invite</a>
            </div>
            @endguest
    ...
    <div x-show="mobileMenu" x-transition class="md:hidden bg-white border-t">
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="#about" class="text-gray-600 hover:text-gray-900 block px-3 py-2 text-base font-medium">About Us</a>
            <a href="#contact" class="text-gray-600 hover:text-gray-900 block px-3 py-2 text-base font-medium">Contact Us</a>
            <a href="{{ route('login') }}" class="w-full text-center bg-orange-500 text-white px-3 py-2 rounded-lg text-base font-medium block">Login</a>
        </div>
        @else
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('register') }}" class="w-full bg-orange-500 text-white px-3 py-2 rounded-lg text-base font-medium hover:bg-orange-600 transition-colors text-center block">Invite</a>
            <form method="POST" action="{{ route('logout') }}">
                @csrf
